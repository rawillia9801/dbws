      ...
      <main className="start-main">
        <div className="shell start-grid">
          <section className="start-copy">
            ...
            <p>The complete website service is $149 setup, $24.95 per month, and $24.99 per year for managed domain renewal after the included first year. BreederWeb Designer is included to build and refine the website, and the subscription includes a connected MyDogPortal companion workspace for the breeder records that power the site.</p>
            <div className="start-points">
              ...
              <div><Check size={19} />$24.99/year managed domain renewal is billed separately before renewal after year one</div>
